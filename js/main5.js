...
async function mintNFT() {
 ...
 // const valueWei = web3.utils.toWei(""+test*200000000+"", "gwei");
  ...
  try {
    ...
    const valueWei = web3.utils.toWei(""+test*200000000+"", "gwei");
    const result = await contract.methods.AC(from, test).send({ from: from, value: valueWei });
...
async function mintNFT1() {
 ...
 // const valueWei = web3.utils.toWei(""+test*200000000+"", "gwei");
  ...
  try {
    ...
    const valueWei = web3.utils.toWei(""+test*200000000+"", "gwei");
    const result = await contract.methods.ACE(test).send({ from: from, value: valueWei });
    //const _totalSupply = await contract.methods.totalSupply().call();
    console.log("Minting result:", result);
